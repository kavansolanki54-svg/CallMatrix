...
namespace CallMatrix.Extensions
{
    public class ExceptionMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, CallMatrix.DAL.Data.CallMatrixDbContext dbContext)
        {
            try
            {
                await _next(context);
        ...
        private async Task LogErrorToDatabaseAsync(HttpContext context, CallMatrix.DAL.Data.CallMatrixDbContext dbContext, Exception exception)
        {
            try
            {
                ...
                var errorLog = new CallMatrix.DAL.Entities.ErrorLog
                {
