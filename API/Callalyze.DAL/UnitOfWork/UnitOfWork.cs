...
using Callalyze.DAL.Repositories.Implementations;
using Callalyze.DAL.Repositories.Interfaces;
using Microsoft.EntityFrameworkCore.Storage;

namespace Callalyze.DAL.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(CallalyzeDbContext context, IDbConnectionFactory connectionFactory)
        {
            _context = context;
