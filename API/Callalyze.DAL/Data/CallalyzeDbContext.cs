...
public partial class CallalyzeDbContext : DbContext
{
    private readonly ICurrentUserService? _currentUserService;

    public CallalyzeDbContext(DbContextOptions<CallalyzeDbContext> options, ICurrentUserService? currentUserService = null)
        : base(options)
    {
