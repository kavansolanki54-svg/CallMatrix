...
namespace Callalyze.DAL.Repositories.Implementations
{
    ...
    {
        public LeadRepository(CallalyzeDbContext context, IDbConnectionFactory connectionFactory)
    ...
    {
        public CustomerRepository(CallalyzeDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    ...
    {
        public ContactRepository(CallalyzeDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    ...
    {
        public FollowUpRepository(CallalyzeDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    ...
    {
        public TaskRepository(CallalyzeDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    ...
    {
        public NoteRepository(CallalyzeDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
