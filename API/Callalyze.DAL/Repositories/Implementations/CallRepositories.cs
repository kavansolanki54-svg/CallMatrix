...
namespace Callalyze.DAL.Repositories.Implementations
{
    ...
    {
        public CallRepository(CallalyzeDbContext context, IDbConnectionFactory connectionFactory)
    ...
    {
        public CallRecordingRepository(CallalyzeDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
