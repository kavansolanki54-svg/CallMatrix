...
namespace Callalyze.DAL.Repositories.Generic
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        protected readonly CallalyzeDbContext _context;
        protected readonly IDbConnectionFactory _connectionFactory;
        protected readonly string _tableName;

        public GenericRepository(CallalyzeDbContext context, IDbConnectionFactory connectionFactory)
        {
            _context = context;
