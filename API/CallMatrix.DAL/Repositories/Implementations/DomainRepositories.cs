...
namespace CallMatrix.DAL.Repositories.Implementations
{
    ...
    {
        public CompanyRepository(CallMatrixDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    }

    public class BranchRepository : GenericRepository<BranchMaster>, IBranchRepository
    {
        public BranchRepository(CallMatrixDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    }

    public class DepartmentRepository : GenericRepository<DepartmentMaster>, IDepartmentRepository
    {
        public DepartmentRepository(CallMatrixDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    }

    public class DesignationRepository : GenericRepository<DesignationMaster>, IDesignationRepository
    {
        public DesignationRepository(CallMatrixDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    }

    public class EmployeeRepository : GenericRepository<EmployeeMaster>, IEmployeeRepository
    {
        public EmployeeRepository(CallMatrixDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    ...
    {
        public RoleRepository(CallMatrixDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    ...
    {
        public MenuRepository(CallMatrixDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    ...
    {
        public RolePermissionRepository(CallMatrixDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    ...
    {
        public RefreshTokenRepository(CallMatrixDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    ...
    {
        public LoginHistoryRepository(CallMatrixDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
    ...
    {
        public EnumTypeRepository(CallMatrixDbContext context, IDbConnectionFactory connectionFactory)
            : base(context, connectionFactory) { }
