...
namespace Callalyze.Utilities.Helper
{
    public class JwtHelper
    {
        ...
        {
            var secretKey = _config["JwtSettings:SecretKey"] ?? "CallalyzeSuperSecretKey2026!EnterpriseSecureJwtToken";
            var issuer = _config["JwtSettings:Issuer"] ?? "Callalyze";
            var audience = _config["JwtSettings:Audience"] ?? "CallalyzeApp";
