...
class MainActivity: FlutterActivity() {
    ...
    override fun onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            registerReceiver(syncReceiver, android.content.IntentFilter("com.callalyze.SYNC_COMPLETE"), Context.RECEIVER_EXPORTED)
        } else {
            registerReceiver(syncReceiver, android.content.IntentFilter("com.callalyze.SYNC_COMPLETE"))
        }
    }
